...
Demo privada del mes fiscal para RESICO. Incluye movimientos ficticios, pendientes, cierre simulado y expediente sin validez fiscal. El progreso de agosto se guarda por cuenta en D1 y se recupera al volver. El resumen de documentos y cobros permite consultar julio, agosto y septiembre; el recorrido de cierre conserva sus ejemplos fijos. El acceso utiliza la identidad de ChatGPT proporcionada por Sites.
...
1. Entrar, abrir Documentos, leer «Servicio de agosto» y volver a Resumen. Debe mostrar $6,960 documentados, $0 cobrados y $6,960 pendientes. Confirmar el cobro de agosto: $6,960 cobrados y $0 pendientes. Deshacer devuelve el pendiente.
2. Abrir «Explorar recorrido de cierre con importes fijos» y resolver un pendiente de agosto.
3. Recargar: debe conservarse el progreso.
4. Resolver el otro pendiente y seguir revisión, autorización, presentación y pago simulados.
5. Descargar el expediente rotulado como demostración.
6. Reiniciar la demo: vuelve al estado inicial de esa cuenta.
7. En dos pestañas abiertas, intentar guardar sobre una versión anterior: la segunda debe solicitar recargar.
