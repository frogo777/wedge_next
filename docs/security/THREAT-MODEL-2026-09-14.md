...
| T10 | Borrado/backup/restore incompleto | Alta | Media | Pérdida o retención indebida | Política aprobada; descarga y borrado sintéticos probados en sesión real; tombstone y reconciliador probados | Lock/lifecycle remoto y restore aislado |
