...
| T10 | Borrado/backup/restore incompleto | Alta | Media | Pérdida o retención indebida | Política aprobada; descarga/borrado sintéticos probados; ruta S3 separada falla cerrada | Activar R2 propio, aplicar lock/lifecycle y ejecutar restore aislado |
