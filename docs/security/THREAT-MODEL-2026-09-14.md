...
| T10 | Borrado/backup/restore incompleto | Alta | Media | Pérdida o retención indebida | Borrado R2→D1 reintentable; auditoría detecta faltantes/huérfanos/alteración | Aprobar política, exportación completa, registro de borrado y restore aislado |
