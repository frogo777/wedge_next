...
| T10 | Borrado/backup/restore incompleto | Alta | Media | Pérdida o retención indebida | Política piloto aprobada; borrado R2→D1 reintentable; auditoría y exportación completa probadas localmente | Registro de borrado, descarga autenticada y restore aislado |
