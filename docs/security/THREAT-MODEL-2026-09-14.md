...
| T10 | Borrado/backup/restore incompleto | Alta | Media | Pérdida o retención indebida | Política aprobada; descarga publicada; tombstone previo, borrado completo y reconciliador offline probados localmente | Descarga desde sesión real, lock/lifecycle remoto y restore aislado |
