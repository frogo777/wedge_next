...
La evidencia y la recomendación de piloto están en [Retención y recuperación de originales](../research/RETENTION-RECOVERY-2026-09-14.md). No se configura bucket lock: impediría el borrado activo que este módulo promete y Wedge todavía no tiene una base legal aprobada para retener contra una solicitud.
