...
Antes de ingesta real: cerrar condiciones de privacidad y retención, validar fuentes/catálogos completos y casos de referencia, definir escaneo y límites del lote, completar la prueba de recuperación y conectar la clasificación documental con revisión fiscal y evidencia de cobro. Los ejemplos del catálogo cerrado ya ejercitan R2 privado, exportación y borrado según [ADR 0002](decisions/0002-private-source-storage.md); no existe una ruta que acepte archivos propios. No confundir «archivo recibido» con «ingreso cobrado».
