...
Antes de ingesta real: cerrar condiciones de privacidad y retención, validar fuentes/catálogos completos y casos de referencia, definir escaneo y límites del lote, completar la prueba de recuperación y conectar la clasificación documental con revisión fiscal y evidencia de cobro. Los originales futuros se conservarán también en R2 privado según [ADR 0002](decisions/0002-private-source-storage.md); el núcleo todavía no tiene ruta ni despliegue. No confundir «archivo recibido» con «ingreso cobrado».
