...
**Avance preparatorio WDG-009A:** investigación oficial y política recomendada para el piloto; auditoría D1/R2 de sólo lectura con verificación de contenido opcional. Detecta faltantes, alterados y huérfanos sin exponer bytes. Pendientes la aprobación de retención, exportación completa, registro de borrados independiente y restore remoto sintético.
