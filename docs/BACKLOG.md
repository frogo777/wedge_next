...
**Avance WDG-009A/B/C/D:** política del piloto aprobada; auditoría D1/R2, ZIP autenticado, borrado integral, tombstones y reconciliación offline probados localmente con el catálogo sintético. No filtra claves R2 y aborta ante fuentes incompletas, alteración o revocación. [ADR 0003](decisions/0003-restore-safe-deletion-registry.md) fija 45 días para el identificador mínimo. Pendientes publicación/prueba del ZIP, lock/lifecycle remoto y restore sintético.
